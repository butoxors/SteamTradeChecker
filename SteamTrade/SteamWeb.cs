    ...
    public class SteamWeb
    {
        ...
        public void Authenticate(System.Collections.Generic.IEnumerable<Cookie> cookies)
        {
            ...
            foreach (var cookie in cookies)
            {
                ...
                else if (cookie.Name.Contains("steamMachineAuth"))
                    token = cookie.Value;
            ...
            if (token == null)
                throw new ArgumentException("Cookie with name \"steamMachineAuth\" is not found.");
            if (tokenSecure == null)
        ...
        public bool VerifyCookies()
        {
            ...
            {
                return response.Cookies["sessionid"] == null || !response.Cookies["sessionid"].Value.Equals("deleted");
            }
        }
