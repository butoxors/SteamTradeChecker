...
namespace Main
{
    ...
    public partial class DotaMoney
    {
        [JsonProperty("id")]
    ...
    public partial class DotaMoney
    {
        public static List<DotaMoney> FromJson(string json) => JsonConvert.DeserializeObject<List<DotaMoney>>(json, Converter.Settings);
    }

    public static class SerializeMoney
    {
        public static string ToJson(this List<DotaMoney> self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
